...
export default function ChampionsCarousel() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full py-16 md:py-24 px-4 md:px-8 bg-linear-to-b from-black via-zinc-900 to-black overflow-hidden min-h-212"
    ...
    >
      ...
      <div ref={cardRef} className="relative flex flex-col md:flex-row items-center justify-center gap-8 bg-linear-to-br from-zinc-900 to-black border border-orange-500/20 rounded-2xl p-8 md:p-12 shadow-2xl shadow-orange-600/10 overflow-hidden min-h-105 md:min-h-80 transition-all duration-300">
